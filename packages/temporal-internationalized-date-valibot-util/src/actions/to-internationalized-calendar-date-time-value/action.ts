        ...
        '~run'(dataset, config) {
            try {
                if (typeof dataset.value === 'string') {
                    dataset.value = parseDateTime(dataset.value);
                } else if (dataset.value instanceof Temporal.ZonedDateTime) {
                    dataset.value = toCalendarDateTime(parseZonedDateTime(dataset.value.toString()));
                } else if (dataset.value instanceof Temporal.PlainDateTime) {
                    dataset.value = parseDateTime(dataset.value.toString());
                } else if (dataset.value instanceof ZonedDateTime) {
                    dataset.value = toCalendarDateTime(dataset.value);
