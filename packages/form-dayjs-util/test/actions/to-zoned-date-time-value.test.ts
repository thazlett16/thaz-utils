...
describe('toZonedDateTime', () => {
  ...
  describe('should convert DayJS to Temporal.ZonedDateTime using options.timeZone', () => {
    test('converts a UTC DayJS to UTC ZonedDateTime', () => {
    ...
    test('converts a UTC DayJS to America/Chicago ZonedDateTime (CDT, UTC-5)', () => {
    ...
    test('converts a UTC DayJS to America/Chicago ZonedDateTime (CST, UTC-6)', () => {
      const action = toZonedDateTime({ timeZone: 'America/Chicago' });
    ...
    test('converts a DayJS just before DST spring-forward (01:59:59 CST → UTC 07:59:59)', () => {
    ...
    test('converts a DayJS just after DST spring-forward (03:00:00 CDT → UTC 08:00:00)', () => {
      const action = toZonedDateTime({ timeZone: 'America/Chicago' });
    ...
    test('converts a DayJS during DST fall-back (first 01:30 CDT → UTC 06:30)', () => {
    ...
    test('converts a DayJS during DST fall-back (second 01:30 CST → UTC 07:30)', () => {
      const action = toZonedDateTime({ timeZone: 'America/Chicago' });
    ...
    test('converts a DayJS with options.timeZone = Asia/Tokyo (UTC+9)', () => {
    ...
    test('converts a DayJS with options.timeZone = Australia/Sydney (AEDT, UTC+11)', () => {
    ...
    test('preserves milliseconds in conversion', () => {
      const action = toZonedDateTime({ timeZone: 'UTC' });
    ...
    test('converts a DayJS at the exact DST spring-forward boundary (07:59:59.999 UTC → 01:59:59.999 CST, last moment before gap)', () => {
    ...
    test('converts a DayJS 1ms into the DST spring-forward gap boundary (08:00:00 UTC → 03:00:00 CDT)', () => {
