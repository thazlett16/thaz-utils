...
describe('normalizeFieldValueDayJS', () => {
  describe('should convert Temporal.ZonedDateTime to a timezone-aware DayJS', () => {
    test('converts a UTC ZonedDateTime (summer, CDT) — DST case', () => {
    ...
    test('converts a UTC ZonedDateTime (winter, CST) — standard time case', () => {
    ...
    test('converts a ZonedDateTime with a positive UTC offset (Asia/Tokyo, UTC+9)', () => {
  ...
  describe('should convert Temporal.Instant to a timezone-aware DayJS', () => {
    test('converts a Temporal.Instant at summer UTC (CDT, UTC-5)', () => {
      // 17:00 UTC → 12:00 CDT
    ...
    test('converts a Temporal.Instant at winter UTC (CST, UTC-6)', () => {
      // 18:00 UTC → 12:00 CST
    ...
    test('converts a Temporal.Instant at the UTC epoch', () => {
  ...
  describe('should convert Temporal.PlainDateTime to a timezone-aware DayJS', () => {
    test('converts a Temporal.PlainDateTime preserving wall-clock components', () => {
    ...
    test('converts a Temporal.PlainDateTime preserving minutes/seconds/milliseconds', () => {
  ...
  describe('should throw FormTypeError for invalid types', () => {
    test('throws FormTypeError for a string value', () => {
      expect(() => normalizeFieldValueDayJS('2024-06-15T12:00:00Z' as never, { timeZone: 'UTC' })).toThrow(
        FormTypeError,
      );
    });

    test('throws FormTypeError for a number value', () => {
      expect(() => normalizeFieldValueDayJS(1_718_452_800_000 as never, { timeZone: 'UTC' })).toThrow(FormTypeError);
    });
  });
});
