...
describe('zonedDateTime', () => {
  describe('nullable overload', () => {
    ...
    test('inferInput includes Temporal.ZonedDateTime, Dayjs, null, and undefined', () => {
      expectTypeOf<v.InferInput<typeof schema>>().toEqualTypeOf<Temporal.ZonedDateTime | Dayjs | null | undefined>();
    });
