...
describe('zonedDateTime', () => {
  describe('nullable overload', () => {
    ...
    it('converts an @internationalized/date ZonedDateTime to Temporal.ZonedDateTime', () => {
      const result = v.safeParse(schema, anIntlZdt);
      expect(result.success).toBeTruthy();
      expect(result.output).toEqual(Temporal.ZonedDateTime.from(anIntlZdt.toString()));
    });
