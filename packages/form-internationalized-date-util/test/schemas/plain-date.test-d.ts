...
describe('plainDate', () => {
  describe('nullable overload', () => {
    ...
    it('inferInput includes Temporal.PlainDate, Temporal.ZonedDateTime, Temporal.PlainDateTime, ZonedDateTime, CalendarDateTime, CalendarDate, null, and undefined', () => {
