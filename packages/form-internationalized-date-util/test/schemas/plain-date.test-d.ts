...
describe('plainDate', () => {
  describe('nullable overload', () => {
    ...
    test('inferInput includes Temporal.PlainDate, Temporal.ZonedDateTime, Temporal.PlainDateTime, ZonedDateTime, CalendarDateTime, CalendarDate, null, and undefined', () => {
