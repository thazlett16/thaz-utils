...
describe('normalizeFieldValueCalendarDate', () => {
  it('converts a Temporal.ZonedDateTime (Chicago CDT) to CalendarDate with correct year/month/day', () => {
  ...
  it('converts a Temporal.PlainDateTime to CalendarDate with correct date components', () => {
  ...
  it('converts a Temporal.PlainDate to CalendarDate', () => {
  ...
  it('converts an @internationalized/date ZonedDateTime to CalendarDate', () => {
  ...
  it('converts an @internationalized/date CalendarDateTime to CalendarDate', () => {
  ...
  it('passes a CalendarDate through unchanged', () => {
