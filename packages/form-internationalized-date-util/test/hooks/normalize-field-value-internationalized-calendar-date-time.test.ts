...
describe('normalizeFieldValueCalendarDateTime', () => {
  test('converts a Temporal.ZonedDateTime to CalendarDateTime', () => {
  ...
  test('converts a Temporal.PlainDateTime to CalendarDateTime', () => {
  ...
  test('converts an @internationalized/date ZonedDateTime to CalendarDateTime', () => {
  ...
  test('passes a CalendarDateTime through unchanged', () => {
